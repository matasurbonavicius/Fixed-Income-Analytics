...
// Target discount rate: 2.5998%
// Yield curve base: 2.3%
// Required spread: 0.2998% = 29.98 bps
const manualSpreadBps = 29.98;
...
if (metrics.discountRate) {
  ...
  console.log(`Breakdown: Base Rate 2.3% + Spread 0.2998% = ${calcRate.toFixed(6)}%`);
}

...
// Empty market data store (no market prices needed)
const marketDataStore = MarketDataStore.create([]);

// === CREATE CALCULATION OPTIONS ===
// Discount rate waterfall - using manual rate
...
// Manual discount rate (Bloomberg: 3.034080%)
const manualRateResult = Percentage.fromDecimal(0.03034080);

...
const internalRatingId = "a1b2c3d4-e5f6-7890-abcd-ef1234567890";
...
const marketData: MarketData = {
  ...
  internalRatingSpread: [
    {
      id: internalRatingId,
      name: "Lithuania Sovereign - High Quality",
      spreadBps: 53.408, // 0.534080% spread = 53.408 bps
    },
    {
      id: "other-rating-id",
      name: "Lower Quality Corporate",
...
if (metrics.discountRate) {
  ...
  console.log(`Internal Rating: Lithuania Sovereign - High Quality`);
  console.log(`Breakdown: Base Rate 2.5% + Internal Rating Spread 0.534080% = ${calcRate.toFixed(6)}%`);
}

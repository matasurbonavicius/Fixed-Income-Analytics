  ...
  creditSpread: [
    {
      ...
      currency,
      spread: 0.00334080, // 33.408 bps = 0.334080%
    },
    {
      rating: ratingA.value,
      currency,
      spread: 0.00534080, // 53.408 bps = 0.534080%
    },
    {
      rating: ratingBBB.value,
      currency,
      spread: 0.0100, // 100 bps = 1.0%
    },
  ],
};
...
if (metrics.discountRate) {
  ...
  console.log(`Breakdown: Base Rate 2.5% + Rating A Spread 0.534080% = ${calcRate.toFixed(6)}%`);
}

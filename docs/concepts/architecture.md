...
│   formulas · specifications · shared          │
└─────────────────────────────────────────────┘
                        │  depends on
                        ▼
┌─────────────────────────────────────────────┐
...
See the [Methodology](./methodology) for the financial math itself, and the [Design decisions](./design-decisions) for the rationale behind these choices.

...
This is a standard CLA, adapted from the Apache Software Foundation's Individual Contributor License
Agreement. It does **not** take your rights away — you keep full ownership of and the right to use
your own contributions. It grants the project lead the licenses needed to include your contribution
and to keep the project's relicensing options open.

You accept this agreement by the method described in [`CONTRIBUTING.md`](./CONTRIBUTING.md) (for
...
Subject to the terms of this Agreement, You hereby grant to the Project Lead and to recipients of
software distributed by the Project Lead a perpetual, worldwide, non-exclusive, no-charge,
royalty-free, irrevocable copyright license to reproduce, prepare derivative works of, publicly
display, publicly perform, sublicense, and distribute Your Contributions and such derivative works.

This license expressly includes the right for the Project Lead to **license and relicense** Your
Contribution, including under the Apache License 2.0, under other open-source licenses, and under
proprietary or commercial license terms, and to combine it with other software. You retain all
right, title, and interest in Your Contribution and may use it for any purpose.
...
use, offer to sell, sell, import, and otherwise transfer the Work, where such license applies only
to those patent claims licensable by You that are necessarily infringed by Your Contribution alone
or by combination of Your Contribution with the Work to which it was submitted.
...
a. You are legally entitled to grant the above licenses. If Your employer(s) has rights to
   ...
   waived such rights for Your Contributions, or that Your employer has executed a separate
...
Lead separately from any Contribution, identifying the complete details of its source and of any
...
You agree to notify the Project Lead of any facts or circumstances of which You become aware that

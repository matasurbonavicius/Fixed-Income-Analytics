...
grant. (Apache-2.0 explicitly does not license trademarks; this document states how the project's
name is treated.)
...
- Use the name as **your own** product, company, or service name.

## In short

> Take the code and do what you like with it. Just don't pass your version off as *this* project,
> and don't use the name in a way that suggests I stand behind something I don't.

Questions or permission requests: open an issue or contact the project lead.

No registered trademark is claimed at this time; this policy states the project's intent and may be
backed by registration in the future.
